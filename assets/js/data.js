window.GYM_SEED = {
  ...
  machines: [
    { id: "ma1", code: "CAR-001", name: "Caminadora Pro X", type: "Cardio", areaId: "a-cardio", brand: "Nordic", model: "T9", simultaneousCapacity: 1, acquiredAt: "2024-02-10", lastMaintenance: "2026-08-10", nextMaintenance: "2026-10-10", certificate: { number: "CERT-CAR-2026-001", issuer: "Quality Fitness Labs", issuedAt: "2026-08-10", expiresAt: "2027-08-10", status: "Aprobado", fileName: "cert-car-001.pdf", fileType: "PDF", purchaseOrderId: "po1", reviewedBy: "Valeria Rivas", reviewedAt: "2026-08-12", observations: "Certificado vigente.", history: [] }, notes: "Banda nueva", purchaseOrderId: "po1", status: "Operativo" },
    { id: "ma2", code: "PES-001", name: "Prensa 45", type: "Fuerza", areaId: "a-pesas", brand: "Hammer", model: "L45", simultaneousCapacity: 2, acquiredAt: "2021-03-16", lastMaintenance: "2026-08-20", nextMaintenance: "2026-11-20", certificate: { number: "", issuer: "", issuedAt: "", expiresAt: "", status: "Pendiente", fileName: "", fileType: "", purchaseOrderId: "", reviewedBy: "", reviewedAt: "", observations: "Certificado requerido antes de activar.", history: [] }, notes: "Pendiente de documentacion de calidad.", status: "Pendiente de documentacion" },
    { id: "ma3", code: "BOX-001", name: "Ring de boxeo", type: "Boxeo", areaId: "a-boxeo", brand: "CombatFit", model: "R15", simultaneousCapacity: 15, acquiredAt: "2025-05-10", lastMaintenance: "2026-08-01", nextMaintenance: "2026-10-01", certificate: { number: "CERT-BOX-2026-001", issuer: "Federacion Guatemalteca de Boxeo", issuedAt: "2026-08-01", expiresAt: "2027-08-01", status: "Aprobado", fileName: "cert-ring-boxeo.pdf", fileType: "PDF", purchaseOrderId: "po1", reviewedBy: "Valeria Rivas", reviewedAt: "2026-08-01", observations: "Certificado de calidad vigente; apto para clases y reservas.", history: [] }, notes: "Recurso principal del area de Boxeo.", purchaseOrderId: "po1", status: "Operativo" },
    { id: "ma4", code: "SPI-001", name: "Bike Sprint A", type: "Spinning", areaId: "a-spinning", brand: "Keiser", model: "M3", simultaneousCapacity: 1, acquiredAt: "2024-04-22", lastMaintenance: "2026-07-30", nextMaintenance: "2026-09-30", certificate: { number: "CERT-SPI-2026-004", issuer: "Bike Studio QA", issuedAt: "2026-08-03", expiresAt: "2027-08-03", status: "En revision", fileName: "cert-spi-001.pdf", fileType: "PDF", purchaseOrderId: "po2", reviewedBy: "", reviewedAt: "", observations: "Pendiente de revision final.", history: [] }, notes: "", purchaseOrderId: "po2", status: "En mantenimiento" },
    { id: "ma5", code: "FUN-001", name: "Estacion funcional", type: "Funcional", areaId: "a-funcional", brand: "TRX", model: "Studio", simultaneousCapacity: 4, acquiredAt: "2025-06-12", lastMaintenance: "2026-08-18", nextMaintenance: "2026-10-18", certificate: { number: "CERT-FUN-2026-005", issuer: "SportLine Control", issuedAt: "2026-08-18", expiresAt: "2027-08-18", status: "Rechazado", fileName: "cert-fun-001.jpg", fileType: "JPG", purchaseOrderId: "", reviewedBy: "Valeria Rivas", reviewedAt: "2026-08-20", observations: "Imagen ilegible; reemplazar certificado.", history: [] }, notes: "No activar hasta reemplazar certificado.", status: "Pendiente de documentacion" },
    { id: "ma6", code: "CAR-002", name: "Eliptica Pulse", type: "Cardio", areaId: "a-cardio", brand: "LifeFit", model: "E7", simultaneousCapacity: 1, acquiredAt: "2022-01-15", lastMaintenance: "2026-07-15", nextMaintenance: "2026-09-15", certificate: { number: "CERT-CAR-2025-002", issuer: "Quality Fitness Labs", issuedAt: "2025-07-01", expiresAt: "2026-08-31", status: "Vencido", fileName: "cert-car-002.png", fileType: "PNG", purchaseOrderId: "", reviewedBy: "Mario Escobar", reviewedAt: "2025-07-03", observations: "Debe renovarse antes de operar.", history: [] }, notes: "Certificado vencido.", status: "Pendiente de documentacion" },
    { id: "ma7", code: "PES-002", name: "Banco olimpico", type: "Fuerza", areaId: "a-pesas", brand: "Hammer", model: "OB2", simultaneousCapacity: 1, acquiredAt: "2026-09-05", lastMaintenance: "2026-09-05", nextMaintenance: "2026-12-05", certificate: { number: "CERT-PES-2026-007", issuer: "Hammer QA", issuedAt: "2026-09-05", expiresAt: "2027-09-05", status: "Cargado", fileName: "cert-pes-002.pdf", fileType: "PDF", purchaseOrderId: "po2", reviewedBy: "", reviewedAt: "", observations: "Archivo cargado; pendiente enviar a revision.", history: [] }, notes: "Equipo nuevo con certificado cargado.", purchaseOrderId: "po2", status: "Pendiente de documentacion" }
  ],
  memberships: [
